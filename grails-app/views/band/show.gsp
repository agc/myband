	...
	<body>
		...
		<div id="show-band" class="content scaffold-show" role="main">
			...
			<ol class="property-list band">
				...
				<g:if test="${bandInstance?.gigs}">
				<li class="fieldcontain">
					<span id="gigs-label" class="property-label"><g:message code="band.gigs.label" default="Gigs" /></span>
					
						<g:each in="${bandInstance.gigs}" var="g">
						<span class="property-value" aria-labelledby="gigs-label"><g:link controller="gig" action="show" id="${g.id}">${g?.encodeAsHTML()}</g:link></span>
						</g:each>
					
				</li>
				</g:if>
			
				<g:if test="${bandInstance?.members}">
				<li class="fieldcontain">
					<span id="members-label" class="property-label"><g:message code="band.members.label" default="Members" /></span>
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:link class="edit" action="edit" id="${bandInstance?.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
