...
<head>
    ...
    <r:require modules="jqgridmember"/>
...
<div class="body">
    ...
    <div id="gridWrapper" class="ui-widget-header ui-corner-all" style="overflow: auto;">
        ...
        <table id="memberGrid" class="scroll jqTable" style="width: 100%;" cellpadding="0" cellspacing="0"></table>
        <!-- pager will hold our paginator -->
        <div id="memberGridPager" class="scroll" style="text-align:center;"></div>
    </div>
</div>
