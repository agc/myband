			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="phoneNumber" title="${message(code: 'member.phoneNumber.label', default: 'Phone Number')}" />
					
						<g:sortableColumn property="dateCreated" title="${message(code: 'member.dateCreated.label', default: 'Date Created')}" />
					
						<g:sortableColumn property="lastUpdated" title="${message(code: 'member.lastUpdated.label', default: 'Last Updated')}" />
				...
				<g:each in="${memberInstanceList}" status="i" var="memberInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:formatDate date="${memberInstance.lastUpdated}" /></td>
